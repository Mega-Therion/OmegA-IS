...
class IdentityManager:
    ...
    async def save(self) -> None:
        ...
        phrases_cast = ":phrases::jsonb" if dialect == "postgresql" else ":phrases"
        constraints_cast = ":constraints::jsonb" if dialect == "postgresql" else ":constraints"
        preferences_cast = ":preferences::jsonb" if dialect == "postgresql" else ":preferences"
                ...
                conn.execute(
                    text(f"""
                        INSERT INTO omega_identity (
                            ...
                            :voice_style, :greeting, {phrases_cast},
                            {constraints_cast}, {preferences_cast}, {ts_func}
                        )
