...
const OPENAI_AUDIO_TIMEOUT_MS = parseInt(process.env.OPENAI_AUDIO_TIMEOUT_MS || '20000', 10);
...
const LOCAL_ASR_FALLBACK_TIMEOUT_MS = parseInt(process.env.LOCAL_ASR_FALLBACK_TIMEOUT_MS || '40000', 10);
